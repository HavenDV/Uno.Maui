...
namespace Microsoft.Maui.LifecycleEvents
{
	public static class WindowsLifecycle
	{
		...
		public delegate void OnClosed(UI.Xaml.Window window, CoreWindowEventArgs args);
		...
		public delegate void OnVisibilityChanged(UI.Xaml.Window window, VisibilityChangedEventArgs args);
