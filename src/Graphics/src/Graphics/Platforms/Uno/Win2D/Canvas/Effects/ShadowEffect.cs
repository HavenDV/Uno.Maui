...
public sealed class ShadowEffect : ICanvasEffect, IGraphicsEffect, IGraphicsEffectSource, ICanvasImage, IDisposable, ICustomQueryInterface, IWinRTObject, IDynamicInterfaceCastable, IEquatable<ShadowEffect>
{
    public void Dispose()
    {
    ...
    public bool Equals(ShadowEffect other)
    {
        throw new NotImplementedException();
    }
